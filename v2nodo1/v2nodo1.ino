...
void loop() {
  ...
  client.loop();
//si hay un error en sensor dht
  if(temp == 2147483647){

    String topic = String("test/topic");
    String payload = "{\"domicilio\": \"" + String(NODO) + "\", \"alerta temperatura\": " + 0 + ", \"alerta humedad\": " + 0 + ", \"alerta gas\": 0" + ", \"alerta temp error\": " + String("1}");
  ...
  if(atemp || ahum){
    ...
    String topic = String("test/topic");
    String payload = "{\"domicilio\": \"" + String(NODO) + "\", \"alerta temperatura\": " + String(atemp) + ", \"alerta humedad\": " + String(ahum) + ", \"alerta gas\": 0" + ", \"alerta temp error\": " + String("0}");
